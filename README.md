...
```
$ cargo run -- --iota-endpoint http://0.0.0.0:14265 --network testnet6 --port 3030 --mode online
```
...
```
$ curl --request POST 'http://localhost:3030/construction/metadata' \--header 'Accept: application/json' \--header 'Content-Type: application/json' \--data-raw '{"network_identifier":{"blockchain":"iota","network":"testnet6"}}' | jq
```
...
```
$ curl --request POST 'http://localhost:3030/construction/payloads' \--header 'Accept: application/json' \--header 'Content-Type: application/json' \--data-raw '{"network_identifier":{"blockchain":"iota","network":"testnet6"},"operations":[{"operation_identifier":{"index":0,"network_index":1},"related_operations":[],"type":"UTXO_INPUT","status":"SUCCESS","account":{"address":"atoi1qp6y92dh0dffg3wr0zezew2esjwyppwnds0dqu8faf4xwhkxuk9vwgjke8g"},"amount":{"value":"10000000","currency":{"symbol":"IOTA","decimals":0}},"coin_change":{"coin_identifier":{"identifier":"68482bb32e005f3e2bd31b868fe49cf156908aa9b720c414b369b3dc86fe020b0000"},"coin_action":"coin_spent"},"metadata":{"is_spent":"UTXO_UNSPENT"}},{"operation_identifier":{"index":0,"network_index":1},"related_operations":[],"type":"UTXO_INPUT","status":"SUCCESS","account":{"address":"atoi1qp6y92dh0dffg3wr0zezew2esjwyppwnds0dqu8faf4xwhkxuk9vwgjke8g"},"amount":{"value":"10000000","currency":{"symbol":"IOTA","decimals":0}},"coin_change":{"coin_identifier":{"identifier":"d9980a2e01b4beb590a3440bcec3b681dfd3c6e7e9a27eb5b962e9f8305a7b840000"},"coin_action":"coin_spent"},"metadata":{"is_spent":"UTXO_UNSPENT"}},{"operation_identifier":{"index":0,"network_index":1},"related_operations":[{"index":1}],"type":"UTXO_OUTPUT","status":"SUCCESS","account":{"address":"atoi1qpececkyqjld0wysauk65uhhhrqumf66g0p7f6te43djcw026u97uf7wsq9"},"amount":{"value":"10000000","currency":{"symbol":"IOTA","decimals":0}},"coin_change":{"coin_identifier":{"identifier":"e4bea334f713a29e204db717ec958b598640a1ac9ce557ca2bd671e710c723a50000"},"coin_action":"coin_created"},"metadata":{"is_spent":"UTXO_UNSPENT"}},{"operation_identifier":{"index":1,"network_index":0},"related_operations":[{"index":0}],"type":"UTXO_OUTPUT","status":"SUCCESS","account":{"address":"atoi1qzfzwft6nw2d6q5x6f8ran9g3260mdu846tgvapc4ww9e75vrhfugx962a8"},"amount":{"value":"10000000","currency":{"symbol":"IOTA","decimals":0}},"coin_change":{"coin_identifier":{"identifier":"e4bea334f713a29e204db717ec958b598640a1ac9ce557ca2bd671e710c723a50100"},"coin_action":"coin_created"},"metadata":{"is_spent":"UTXO_UNSPENT"}}]}' | jq```
```

- `/construction/parse`
```
$ curl --request POST 'http://localhost:3030/construction/parse' \--header 'Accept: application/json' \--header 'Content-Type: application/json' \--data-raw '{"network_identifier":{"blockchain":"iota","network":"testnet6"},"signed":false,"transaction":""}' | jq
```
